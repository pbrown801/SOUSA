...
with open('SortedTrimmedAllSwiftSNlist.csv','r') as csv_file:
    ...
    for index in range(3,len(list_of_rows)):
        ...
        #Ia
        if(str(list_of_rows[index][3].strip())=="Iax" or str(list_of_rows[index][3].strip())=="Ia" or str(list_of_rows[index][3].strip())=="Ia-91T-like" or str(list_of_rows[index].strip())=="Ia-91bg" or str(list_of_rows[index][3].strip())=="Ia-pec" or str(list_of_rows[index][3].strip())=="Ia-CSM"  or str(list_of_rows[index][3].strip())=="Ia-SC" or str(list_of_rows[index][3].strip())=="Ia-Ca-rich"): # check for all supernova type one a
