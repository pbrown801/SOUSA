...
ysize = 1.0*(margin + nplots*(b + wall ) )*xsize
ticklen = 0.01
xticklen = ticklen/b
yticklen = ticklen/a
nxticks=10
...
/tt_font, set_font='Times', font_size=12, bits_per_pixel=8, /color
   ...
   cgBarPlot, yearlyOAOobs, position=[x1,y1,x2,y2], xrange=[1970,2020], YRange=[0,10], Colors='forest green', BarNames=yearnames, charthick=4
   ...
   colors = ['forest green','sky blue','red', 'orange', 'purple','blue']
   AL_Legend, labels, Colors=colors, PSym=Replicate(15,6), SymSize=Replicate(1.75,6), $
       charsize=1.5, Charthick=2, Position=[1970,10],  box=0
...
device, filename=figurename, /encapsulated, xsize=xsize, ysize=1.0*0.8*ysize/10, $
/tt_font, set_font='Times', font_size=12, bits_per_pixel=8, /color

   cgBarPlot, yearlyOAOobs, position=[x1,y1*10.0,x2,y2*9.00*1.2], xrange=[1970,2015], YRange=[0,10], Colors='forest green', BarNames=yearnames, charthick=4
